...
namespace DreamHomeApp.Controllers
{
    public class HousesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Town,Adress,LevelsCount,Image,RegistratedOn")] House house)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Town,Adress,LevelsCount,Image,RegistratedOn")] House house)
        {
            if (id != house.Id)
            {
                return NotFound();
